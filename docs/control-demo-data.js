window.CONTROL_DEMO_DATA = {
  ...
  rows: [
    ...
    },
    {
      ...
      items: [
        { label: "0.566", audio: "control/zh_837534/emo_0p5.wav" },
        { label: "0.666", audio: "control/zh_837534/emo_0p6.wav" },
        { label: "0.866", audio: "control/zh_837534/emo_0p8.wav" },
        { label: "0.966", audio: "control/zh_837534/emo_0p9.wav" },
      ],
    },
  ],
};
